...
RUN curl https://s3.amazonaws.com/artifacts.h2o.ai/releases/ai/h2o/dai/1.0.30/x86_64-centos7/dai-1.0.30-1.x86_64.rpm --output dai-1.0.30-1.x86_64.rpm

RUN rpm -ivh dai-1.0.30-1.x86_64.rpm
